        ...
        if(photoType.equals(mContext.getString(R.string.new_photo))) {
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    //add the new 'photo' node and 'user_photo' node
...
//    }
    ...
    /**
     * Retrieves the accoutnsettings for the user currently logged in
     * DAtbase: user_account_Settings node
     * @param dataSnapshot
     * @return
     */
    public UserSettings getUserSettings(DataSnapshot dataSnapshot){
        ...
        for(DataSnapshot ds: dataSnapshot.getChildren()) {
            ...
            if (ds.getKey().equals(mContext.getString(R.string.dbname_user_account_settings))) {
                Log.d(TAG, "getUserAccountSettings: datasnpashot: " + ds);
                ...
                try {
                    ...
                    Log.d(TAG, "getUserAccountSettings: retrieved user_account_settigns information: " + settings.toString());
